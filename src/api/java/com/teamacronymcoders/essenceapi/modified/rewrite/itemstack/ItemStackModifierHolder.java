...
import com.teamacronymcoders.essenceapi.holder.ModifierHolder;
...
public class ItemStackModifierHolder extends ModifierHolder<ItemStack> {
    ...
    public void deserializeNBT(CompoundTag tags) {
        if (stack.getTag() != null)
            super.deserializeNBT(stack.getTag().getCompound(EssenceAPIItemstackModifierHelpers.TAG_MODIFIERS));
    }
