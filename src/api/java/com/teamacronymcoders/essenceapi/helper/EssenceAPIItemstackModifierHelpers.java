...
public class EssenceAPIItemstackModifierHelpers {
    ...
    public static IModifier<?> getModifierByRegistryName(String name) {
        return EssenceRegistries.MODIFIER.get().getValue(new ResourceLocation(name));
    }

    /**
     * Used to get a specific ModifierInstance using a com.teamacronymcoders.essenceapi.modifier from an ItemStack.
     *
     * @param stack    The ItemStack holding the Modifiers.
     * @param modifier The Modifier to get the level off.
     * @return Returns the level of the com.teamacronymcoders.essenceapi.modifier on the tool.
     */
    public static ModifierInstance getModifierInstance(ItemStack stack, IModifier<ItemStack> modifier) {
        final LazyOptional<ItemStackModifierHolder> holderLazyOptional = stack.getCapability(EssenceCapabilities.ITEMSTACK_MODIFIER_HOLDER);
     ...
     * @param modifierData Any additional data related to the com.teamacronymcoders.essenceapi.modifier being applied.
     */
    public static void addModifier(ItemStack stack, IModifier<ItemStack> modifier, int level, CompoundTag modifierData) {
        final LazyOptional<ItemStackModifierHolder> instances = stack.getCapability(EssenceCapabilities.ITEMSTACK_MODIFIER_HOLDER);
        if (stack.getItem() instanceof IModifiedItem && instances.isPresent()) {
            instances.ifPresent(holder -> {
                ...
                stack.getTag().put(EssenceAPIItemstackModifierHelpers.TAG_MODIFIERS, holder.serializeNBT());
            });
        }
    }
    ...
    /**
     * Used to increase the level of a specific com.teamacronymcoders.essenceapi.modifier instance.
     *
     * @param stack         The ItemStack holding the Modifiers.
     * @param checkInstance The com.teamacronymcoders.essenceapi.modifier to increase with.
    ...
    /**
     * Used to decrease the level of a specific com.teamacronymcoders.essenceapi.modifier instance.
     *
     * @param stack         The ItemStack holding the Modifiers.
     * @param checkInstance The com.teamacronymcoders.essenceapi.modifier to decrease with.
     ...
     *
     * @param stack         The ItemStack holding the Modifiers.
     * @param mergeInstance The com.teamacronymcoders.essenceapi.modifier to merge with.
     */
    @SuppressWarnings("unchecked")
