...
import com.teamacronymcoders.essenceapi.helper.EssenceAPIUtilHelper;
...
public interface IModifier<T> {
    ...
    /**
     * Used to dictate if the com.teamacronymcoders.essenceapi.modifier counts towards the maximum com.teamacronymcoders.essenceapi.modifier count of the storage object.
     *
     * @param level The current level of the com.teamacronymcoders.essenceapi.modifier to check against.
     * @return Returns whether the com.teamacronymcoders.essenceapi.modifier counts towards the tool maximum com.teamacronymcoders.essenceapi.modifier slots.
     */
     ...
     *
     * @param level The current level of the com.teamacronymcoders.essenceapi.modifier to check against.
     * @return Returns how many Modifier points the com.teamacronymcoders.essenceapi.modifier currently takes up.
     */
    ...
    /**
     * This returns a boolean check against the provided com.teamacronymcoders.essenceapi.modifier.
     *
     * @param modifier Modifier to check against.
     * @return Returns if this com.teamacronymcoders.essenceapi.modifier can be applied together with the provided Modifier.
     */
    ...
    /**
     * Used to check if the com.teamacronymcoders.essenceapi.modifier can be applied on the provided target object.
     *
     * @param target Target T object.
     * @return Returns whether this com.teamacronymcoders.essenceapi.modifier can be applied on the provided T object.
     */
    ...
    /**
     * Used to handle merging the existing com.teamacronymcoders.essenceapi.modifier data with new com.teamacronymcoders.essenceapi.modifier data.
     *
    ...
    /**
     * Used to update a com.teamacronymcoders.essenceapi.modifier whenever the Tag data gets updated.
     *
    ...
    /**
     * Used to get the translatable string value for the com.teamacronymcoders.essenceapi.modifier name.
     * Example: 'com.teamacronymcoders.essenceapi.modifier.namespace.path' = 'com.teamacronymcoders.essenceapi.modifier.essence.soaked'
     *
     * @return Returns the translation id for the Modifier
     */
    default String getTranslationName() {
        final ResourceLocation id = EssenceRegistries.MODIFIER.get().getKey(this);
        return "com.teamacronymcoders.essenceapi.modifier." + id.getNamespace() + "." + id.getPath();
    }
    ...
    default Component getTextComponentName(int level) {
        ...
        return Component.literal("  ").append(Component.translatable(getTranslationName()).append(" " + EssenceAPIUtilHelper.toRoman(level)).withStyle(ChatFormatting.GRAY));
    }
