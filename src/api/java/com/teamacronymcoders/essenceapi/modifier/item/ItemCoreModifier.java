...
public class ItemCoreModifier extends Modifier<ItemStack> {
     ...
     * @param instance The current instance object for this com.teamacronymcoders.essenceapi.modifier.
    ...
    /**
     * Gets the com.teamacronymcoders.essenceapi.modified max-durability of the item.
     *
     * @param stack    The currently held item.
     * @param instance The current instance object for this com.teamacronymcoders.essenceapi.modifier.
     * @param base     The base durability of the item item.
     * @return Returns the com.teamacronymcoders.essenceapi.modified durability.
     */
    ...
    /**
     * Gets the com.teamacronymcoders.essenceapi.modified destroy speed of the item.
     *
     * @param stack    The currently held item.
    ...
    /**
     * Used to have the com.teamacronymcoders.essenceapi.modified have an associated Enchantment linked to it.
     *
     * @param stack The currently held item.
    ...
    /**
     * Gets the com.teamacronymcoders.essenceapi.modified fluid capacity for the item.
     * This method is used by some items such as:
     *
     * @param stack        The currently held item.
     * @param baseCapacity The base fluid capacity.
     * @param instance     The current instance object for this com.teamacronymcoders.essenceapi.modifier.
     * @return Returns the potentially com.teamacronymcoders.essenceapi.modified fluid capacity.
     * @see "TomeOfExperience"
     */
