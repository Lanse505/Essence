...
public class EssenceRegistration {
    private static final DeferredRegister<Modifier> MODIFIER_DEFERRED_REGISTER = new DeferredRegister<>(GameRegistry.findRegistry(Modifier.class), EssenceReferences.MODID);
    ...
    //public static RegistryObject<AttackDamageModifier> ATTACK_DAMAGE_MODIFIER = MODIFIER_DEFERRED_REGISTER.register("attack_damage_modifier", () -> new AttackDamageModifier());
    //public static RegistryObject<ExpanderModifier> EXPANDER_MODIFIER = MODIFIER_DEFERRED_REGISTER.register("expander_modifier", () -> new ExpanderModifier());
