...
public class EssenceFluidRegistrate {
    ...
    public static final FluidEntry<ForgeFlowingFluid.Flowing> ESSENCE = registrate.fluid("essence", new ResourceLocation(Essence.MOD_ID, "block/fluid/essence_still"), new ResourceLocation(Essence.MOD_ID, "block/fluid/essence_flowing"))
            ...
            .build().bucket().properties(properties -> properties.defaultDurability(16)).tab(() -> Essence.CORE_TAB)
    ...
    public static final FluidEntry<ForgeFlowingFluid.Flowing> EXPERIENCE = registrate.fluid("experience", new ResourceLocation(Essence.MOD_ID, "block/fluid/experience_still"), new ResourceLocation(Essence.MOD_ID, "block/fluid/experience_flowing"))
            .attributes(builder -> builder.sound(SoundEvents.BUCKET_FILL, SoundEvents.BUCKET_EMPTY))
            .source(ForgeFlowingFluid.Source::new)
