...
public class EssenceKnowledgeRegistration {
    ...
    public static RegistryObject<Knowledge<ItemStack>> EFFICIENCY_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("efficiency", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.EFFICIENCY_MODIFIER.get(), 1, null)));
    public static RegistryObject<Knowledge<ItemStack>> INFINITY_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("infinity", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.INFINITY_MODIFIER.get(), 1, null)));
    public static RegistryObject<Knowledge<ItemStack>> KNOCKBACK_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("knockback", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.KNOCKBACK_MODIFIER.get(), 1, null)));
    public static RegistryObject<Knowledge<ItemStack>> LUCK_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("luck", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.LUCK_MODIFIER.get(), 1, null)));
    public static RegistryObject<Knowledge<ItemStack>> SILK_TOUCH_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("silk_touch", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.SILK_TOUCH_MODIFIER.get(), 1, null)));
    public static RegistryObject<Knowledge<ItemStack>> UNBREAKING_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("unbreaking", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.UNBREAKING_MODIFIER.get(), 1, null)));
    public static RegistryObject<Knowledge<ItemStack>> MENDING_MODIFIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("mending", () -> new Knowledge<ItemStack>(ItemStack.class, new ModifierInstance<>(ItemStack.class, () -> EssenceModifierRegistration.MENDING_MODIFIER.get(), 1, null)));
    ...
    public static RegistryObject<Knowledge<ItemStack>> EXALTED_TIER_KNOWLEDGE = KNOWLEDGE_DEFERRED_REGISTER.register("supreme_tier", () -> new Knowledge<>(ItemStack.class));
