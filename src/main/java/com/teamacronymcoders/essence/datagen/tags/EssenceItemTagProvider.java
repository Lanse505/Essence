...
public class EssenceItemTagProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        // Essence Tag<Item>(s)
        getBuilder(EssenceItemTags.ESSENCE_CRYSTAL).add(ESSENCE_INFUSED_CRYSTAL);
        getBuilder(EssenceItemTags.ESSENCE_INFUSED_METAL_NUGGET).add(ESSENCE_INFUSED_METAL_NUGGET, ESSENCE_INFUSED_METAL_EMPOWERED_NUGGET, ESSENCE_INFUSED_METAL_SUPREME_NUGGET, ESSENCE_INFUSED_METAL_DIVINE_NUGGET);
        getBuilder(EssenceItemTags.ESSENCE_INFUSED_METAL).add(ESSENCE_INFUSED_METAL, ESSENCE_INFUSED_METAL_EMPOWERED, ESSENCE_INFUSED_METAL_SUPREME, ESSENCE_INFUSED_METAL_DIVINE);
        getBuilder(EssenceItemTags.ESSENCE_INFUSED_STICK).add(ESSENCE_INFUSED_STICK);
        getBuilder(EssenceItemTags.ESSENCE_INFUSED_METAL_BLOCK).add(ESSENCE_INFUSED_METAL_BLOCK.asItem(), ESSENCE_INFUSED_METAL_EMPOWERED_BLOCK.asItem(), ESSENCE_INFUSED_METAL_SUPREME_BLOCK.asItem(), ESSENCE_INFUSED_METAL_DIVINE_BLOCK.asItem());
        getBuilder(EssenceItemTags.ESSENCE_WOOD_LOG).add(ESSENCE_WOOD_LOG.asItem());
        getBuilder(EssenceItemTags.ESSENCE_WOOD_PLANKS).add(ESSENCE_WOOD_PLANKS.asItem());
        getBuilder(EssenceItemTags.ESSENCE_BRICKS).add(
        ...
        getBuilder(EssenceModifierTags.NONE_TOOL);
        getBuilder(EssenceModifierTags.AXE_TOOL).add(
        ...
        getBuilder(EssenceModifierTags.PICKAXE_TOOL).add(
            ESSENCE_PICKAXE, ESSENCE_PICKAXE_EMPOWERED, ESSENCE_PICKAXE_SUPREME, ESSENCE_PICKAXE_DIVINE,
            ESSENCE_OMNITOOL, ESSENCE_OMNITOOL_EMPOWERED, ESSENCE_OMNITOOL_SUPREME, ESSENCE_OMNITOOL_DIVINE
        );
        getBuilder(EssenceModifierTags.SHOVEL_TOOL).add(
