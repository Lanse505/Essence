...
public class EssenceItemTagProvider extends ItemTagsProvider {
    ...
    protected void registerTags() {
        ...
        getBuilder(EssenceTags.Items.ESSENCE_INFUSED_METAL_NUGGET).add(ESSENCE_INFUSED_METAL_NUGGET, ESSENCE_INFUSED_METAL_EMPOWERED_NUGGET, ESSENCE_INFUSED_METAL_SUPREME_NUGGET, ESSENCE_INFUSED_METAL_GODLY_NUGGET);
        getBuilder(EssenceTags.Items.ESSENCE_INFUSED_METAL).add(ESSENCE_INFUSED_METAL, ESSENCE_INFUSED_METAL_EMPOWERED, ESSENCE_INFUSED_METAL_SUPREME, ESSENCE_INFUSED_METAL_GODLY);
        getBuilder(EssenceTags.Items.ESSENCE_INFUSED_STICK).add(ESSENCE_INFUSED_STICK);
        getBuilder(EssenceTags.Items.ESSENCE_INFUSED_METAL_BLOCK).add(ESSENCE_INFUSED_METAL_BLOCK.asItem(), ESSENCE_INFUSED_METAL_EMPOWERED_BLOCK.asItem(), ESSENCE_INFUSED_METAL_SUPREME_BLOCK.asItem(), ESSENCE_INFUSED_METAL_GODLY_BLOCK.asItem());
        ...
        getBuilder(EssenceTags.Modifier.AXE_TOOL).add(
            ESSENCE_AXE, ESSENCE_AXE_EMPOWERED, ESSENCE_AXE_SUPREME, ESSENCE_AXE_GODLY,
            ESSENCE_OMNITOOL, ESSENCE_OMNITOOL_EMPOWERED, ESSENCE_OMNITOOL_SUPREME, ESSENCE_OMNITOOL_GODLY
        );
        getBuilder(EssenceTags.Modifier.PICKAXE_TOOL).add(
            ESSENCE_PICKAXE, ESSENCE_PICKAXE_EMPOWERED, ESSENCE_PICKAXE_SUPREME, ESSENCE_PICKAXE_GODLY,
            ESSENCE_OMNITOOL, ESSENCE_OMNITOOL_EMPOWERED, ESSENCE_OMNITOOL_SUPREME, ESSENCE_OMNITOOL_GODLY
        );
        getBuilder(EssenceTags.Modifier.SHOVEL_TOOL).add(
            ESSENCE_SHOVEL, ESSENCE_SHOVEL_EMPOWERED, ESSENCE_SHOVEL_SUPREME, ESSENCE_SHOVEL_GODLY,
            ESSENCE_OMNITOOL, ESSENCE_OMNITOOL_EMPOWERED, ESSENCE_OMNITOOL_SUPREME, ESSENCE_OMNITOOL_GODLY
        );
    }
