...
public class StrengthenedModifier extends EnchantmentCoreModifier {
    ...
    public ITextComponent getRenderedText(int level) {
        return new TranslationTextComponent(getTranslationName(), new TranslationTextComponent("strengthened.type." + this.type.getName()).applyTextStyles(this.type.getTextFormatting())).applyTextStyle(TextFormatting.GRAY);
    }
