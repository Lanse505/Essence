...
public class EssenceSword extends SwordItem implements IModifiedTool {
    ...
    public void fillItemGroup(ItemGroup group, NonNullList<ItemStack> list) {
        if (this.isInGroup(group)) {
            ...
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.STRENGTHENED_ARTHROPOD_MODIFIER.get(), Pair.of(5, null));
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.KNOCKBACK_MODIFIER.get(), Pair.of(3, null));
            if (!list.contains(stack)) {
                list.add(stack);
            }
            stack = new ItemStack(this);
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.STRENGTHENED_SHARPNESS_MODIFIER.get(), Pair.of(5, null));
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.KNOCKBACK_MODIFIER.get(), Pair.of(3, null));
            if (!list.contains(stack)) {
                list.add(stack);
            }
            stack = new ItemStack(this);
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.STRENGTHENED_SMITE_MODIFIER.get(), Pair.of(5, null));
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.KNOCKBACK_MODIFIER.get(), Pair.of(3, null));
            if (!list.contains(stack)) {
                list.add(stack);
            }
            stack = new ItemStack(this);
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.STRENGTHENED_POWER_MODIFIER.get(), Pair.of(5, null));
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.KNOCKBACK_MODIFIER.get(), Pair.of(3, null));
            if (!list.contains(stack)) {
                list.add(stack);
            }
            stack = new ItemStack(this);
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.FIERY_MODIFIER.get(), Pair.of(5, null));
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.STRENGTHENED_POWER_MODIFIER.get(), Pair.of(5, null));
            EssenceModifierHelpers.addModifier(stack, EssenceRegistration.KNOCKBACK_MODIFIER.get(), Pair.of(3, null));
            if (!list.contains(stack)) {
                list.add(stack);
