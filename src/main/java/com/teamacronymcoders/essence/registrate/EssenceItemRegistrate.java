...
public class EssenceItemRegistrate {
  ...
  public static ItemEntry<EssenceCrystalItem> ESSENCE_CRYSTAL_EMPOWERED = Essence.ESSENCE_REGISTRATE.object("essence_crystal_empowered").item(properties -> new EssenceCrystalItem(properties, EssenceItemTiers.EMPOWERED)).properties(properties -> properties.tab(Essence.CORE_TAB)).lang("Essence-Infused Crystal").model((context, provider) -> provider.withExistingParent(context.getId().getPath(), new ResourceLocation(Essence.MOD_ID, "item/item")).texture("layer0", new ResourceLocation(Essence.MOD_ID, "item/empowered_essence_crystal"))).tag(EssenceTags.EssenceItemTags.ESSENCE_CRYSTAL).register();
  public static ItemEntry<EssenceCrystalItem> ESSENCE_CRYSTAL_SUPREME = Essence.ESSENCE_REGISTRATE.object("essence_crystal_supreme").item(properties -> new EssenceCrystalItem(properties, EssenceItemTiers.SUPREME)).properties(properties -> properties.tab(Essence.CORE_TAB)).lang("Essence-Infused Crystal").model((context, provider) -> provider.withExistingParent(context.getId().getPath(), new ResourceLocation(Essence.MOD_ID, "item/item")).texture("layer0", new ResourceLocation(Essence.MOD_ID, "item/supreme_essence_crystal"))).tag(EssenceTags.EssenceItemTags.ESSENCE_CRYSTAL).register();
  public static ItemEntry<EssenceCrystalItem> ESSENCE_CRYSTAL_DIVINE = Essence.ESSENCE_REGISTRATE.object("essence_crystal_divine").item(properties -> new EssenceCrystalItem(properties, EssenceItemTiers.DIVINE)).properties(properties -> properties.tab(Essence.CORE_TAB)).lang("Essence-Infused Crystal").model((context, provider) -> provider.withExistingParent(context.getId().getPath(), new ResourceLocation(Essence.MOD_ID, "item/item")).texture("layer0", new ResourceLocation(Essence.MOD_ID, "item/divine_essence_crystal"))).tag(EssenceTags.EssenceItemTags.ESSENCE_CRYSTAL).register();
