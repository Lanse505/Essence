...
public class EssenceItemRegistrate {
  ...
  public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> axeRecipe(DataIngredient ingot, ResourceLocation rl) {
    return (context, provider) -> ShapedRecipeBuilder.shapedRecipe(context.get(), 1).patternLine("ii ").patternLine("is ").patternLine(" s ").key('i', ingot).key('s', EssenceTags.EssenceItemTags.ESSENCE_INFUSED_STICK).addCriterion("has_" + provider.safeName(ingot), ingot.getCritereon(provider)).build(provider, rl);
  }
  ...
  public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> pickaxeRecipe(DataIngredient ingot, ResourceLocation rl) {
    return (context, provider) -> ShapedRecipeBuilder.shapedRecipe(context.get(), 1).patternLine("iii").patternLine(" s ").patternLine(" s ").key('i', ingot).key('s', EssenceTags.EssenceItemTags.ESSENCE_INFUSED_STICK).addCriterion("has_" + provider.safeName(ingot), ingot.getCritereon(provider)).build(provider, rl);
  }
  ...
  public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> shovelRecipe(DataIngredient ingot, ResourceLocation rl) {
    return (context, provider) -> ShapedRecipeBuilder.shapedRecipe(context.get(), 1).patternLine(" i ").patternLine(" s ").patternLine(" s ").key('i', ingot).key('s', EssenceTags.EssenceItemTags.ESSENCE_INFUSED_STICK).addCriterion("has_" + provider.safeName(ingot), ingot.getCritereon(provider)).build(provider, rl);
  }
  ...
  public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> swordRecipe(DataIngredient ingot, ResourceLocation rl) {
    return (context, provider) -> ShapedRecipeBuilder.shapedRecipe(context.get(), 1).patternLine(" i ").patternLine(" i ").patternLine(" s ").key('i', ingot).key('s', EssenceTags.EssenceItemTags.ESSENCE_INFUSED_STICK).addCriterion("has_" + provider.safeName(ingot), ingot.getCritereon(provider)).build(provider, rl);
  }
  ...
  public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> bowRecipe(DataIngredient nugget, ResourceLocation rl) {
    return (context, provider) -> ShapedRecipeBuilder.shapedRecipe(context.get(), 1).patternLine("stn").patternLine("s t").patternLine("stn").key('t', EssenceTags.EssenceItemTags.ESSENCE_INFUSED_STICK).key('s', DataIngredient.tag(Tags.Items.STRING)).key('n', nugget).addCriterion("has_" + provider.safeName(nugget), nugget.getCritereon(provider)).build(provider, rl);
  }
  ...
  public static <T extends Item> NonNullBiConsumer<DataGenContext<Item, T>, RegistrateRecipeProvider> hoeRecipe(DataIngredient ingot, ResourceLocation rl) {
    return (context, provider) -> ShapedRecipeBuilder.shapedRecipe(context.get(), 1).patternLine("ii ").patternLine(" s ").patternLine(" s ").key('i', ingot).key('s', EssenceTags.EssenceItemTags.ESSENCE_INFUSED_STICK).addCriterion("has_" + provider.safeName(ingot), ingot.getCritereon(provider)).build(provider, rl);
  }
}
