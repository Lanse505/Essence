package com.teamacronymcoders.essence.data.loot.condition;
...
public class SerializableModifierPredicateObject {
    ...
    public SerializableModifierPredicateObject(IModifier modifier, @Nullable MinMaxBounds.Ints level) {
