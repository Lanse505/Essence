...
public class EssenceOreFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ESSENCE_CRYSTAL_ORE = FeatureUtils.register("ore_essence_crystal", Feature.ORE.configured(new OreConfiguration(ORE_ESSENCE_TARGET_LIST, 8)));
    public static final ConfiguredFeature<?, ?> ESSENCE_CRYSTAL_ORE_SMALL = FeatureUtils.register("ore_essence_crystal_small", Feature.ORE.configured(new OreConfiguration(ORE_ESSENCE_TARGET_LIST, 4)));
