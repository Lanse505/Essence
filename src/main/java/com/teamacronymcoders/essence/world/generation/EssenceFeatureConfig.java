...
public class EssenceFeatureConfig {
  public static final BaseTreeFeatureConfig SAPLING_ESSENCE_TREE_CONFIG = new BaseTreeFeatureConfig.Builder(
          new SimpleBlockStateProvider(EssenceBlockRegistrate.ESSENCE_WOOD_LOG.getDefaultState()),
          new SimpleBlockStateProvider(EssenceBlockRegistrate.ESSENCE_WOOD_LEAVES.getDefaultState()),
